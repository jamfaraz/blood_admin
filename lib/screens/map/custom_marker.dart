...
class _CustomMarkerScreenState extends State<CustomMarkerScreen> {
  ...
  final List<LatLng> _latLang =  <LatLng>[
    const LatLng(33.6941, 72.9734), const LatLng(33.7008, 72.9682) ,const LatLng(33.6992, 72.9744),
    const LatLng(33.6939, 72.9771), const LatLng(33.6910, 72.9807), const LatLng(33.7036, 72.9785)];
